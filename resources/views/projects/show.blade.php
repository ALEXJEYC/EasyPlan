    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8" x-data="{ tab: 'inicio' }" x-cloak>
        ...
        <div class="mb-6 border-b border-gray-200 dark:border-gray-700">
            <ul class="flex flex-wrap -mb-px text-sm font-medium text-center">
                ...
                @if ($canreviewTasks)
                    <li class="mr-2">
                        <button @click="tab = 'revision'"
                            :class="{ 'border-blue-600 text-blue-600': tab === 'revision' }"
                            class="inline-block p-4 border-b-2 border-transparent hover:border-blue-600 hover:text-blue-600">
                            Revisión
                        </button>
                    </li>
                ...
                <li class="mr-2">
                    <button @click="tab = 'archivos'" :class="{ 'border-blue-600 text-blue-600': tab === 'archivos' }"
                        class="inline-block p-4 border-b-2 border-transparent hover:border-blue-600 hover:text-blue-600">
                        Archivos
                    </button>
                </li>
        ...
        <div x-show="tab === 'archivos'" class="mb-8">
