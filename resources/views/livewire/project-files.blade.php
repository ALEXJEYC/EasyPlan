<div>
    <div class="bg-white dark:bg-gray-800 shadow-md rounded-lg p-6 mb-6">
        ...
        <form wire:submit.prevent="save">
            ...
            @enderror
            <p class="text-xs text-gray-500 dark:text-gray-400 mt-2">Archivos permitidos: Word, Excel, PDF, ZIP. Tamaño
                máximo: 20MB.</p>
        </form>
    </div>
                    ...
                    @forelse ($files as $file)
                        <tr>
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900 dark:text-white">
                                <a href="{{ route('projects.files.download', ['project' => $project, 'file' => $file]) }}"
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400">
                                {{ number_format($file->file_size / 1024, 2) }} KB</td>
