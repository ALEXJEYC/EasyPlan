<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 p-6">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 group overflow-hidden relative isolate">
...
<div class="ps3-hover-effect absolute top-0 h-40 w-full overflow-hidden opacity-0 group-hover:opacity-100 transition-opacity duration-500 bg-gradient-to-b from-white/5 via-black/70 to-black">
    <div class="particle-container absolute inset-0 pointer-events-none"></div>
        ...
        <!-- Contenido -->
         <div class="pt-16 pb-6 px-6 text-center relative z-100">
            ...
            <!-- Acciones -->
            <div class="flex justify-center space-x-4 relative z-100">
...
.ps3-hover-effect {
    ...
    z-index:15; /* Capa intermedia para el efecto */
...
.particle-container {
    z-index: 20; /* Capa superior para partículas */
}
.relative.z-100 {
    z-index: 30; /* Asegura que el contenido esté sobre todo */
}
